#!/usr/bin/env python3
"""Evaluate GRPO evaluator checkpoints on test_qwen.jsonl with parse-aware metrics."""
...
def parse_args() -> argparse.Namespace:
    ...
    p.add_argument("--adapter_path", type=str, default="runs/grpo_from_sft/final_adapter")
    p.add_argument("--test_path", type=str, default="test_qwen.jsonl")
    p.add_argument("--output_path", type=str, default="grpo_eval_results.jsonl")
